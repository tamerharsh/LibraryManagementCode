...
public class RegisterStudent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try
       {
       query="CREATE TABLE if not exists student (`StudentId` VARCHAR(45) NOT NULL,`StudentName` VARCHAR(45) NULL,`SStream` VARCHAR(45) NULL,`SClass` VARCHAR(45) NULL,`Address` VARCHAR(45) NULL,`Email` VARCHAR(45) NULL,PRIMARY KEY (`StudentId`));";
       stmt.execute(query);
       query="insert into student values('"+t1.getText()+"','"+t2.getText()+"','"+c1.getSelectedItem()+"','"+c2.getSelectedItem()+"','"+a1.getText()+"','"+t3.getText()+"');";
       stmt.executeUpdate(query);
       JOptionPane.showMessageDialog(this,"Thank you "+t1.getText()+"\nYou are registered now");
       t1.setText("");
       t2.setText("");
       t3.setText("");
       c1.setSelectedItem("Select Stream");
       c2.setSelectedItem("Select Class");
       a1.setText("");
        }
