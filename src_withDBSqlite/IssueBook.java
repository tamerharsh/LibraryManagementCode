...
public class IssueBook extends javax.swing.JFrame {
    ...
    String  checkAvailability,SName,SEmail,Address,SStream,SClass;
    /**
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addComponent(t2, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
                                                .addComponent(t4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE)
                                                .addComponent(t1)
                                                .addComponent(t5)
                                                .addComponent(t7))
                                            .addComponent(t6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 261, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(t2.getText().equals("")) 
            JOptionPane.showMessageDialog(this,"do Registeration first");
        else
        {
                try
                    {
                        ...
                        {
                            query="CREATE TABLE if not exists issue (`StudentId` VARCHAR(45) NOT NULL,`StudentName` VARCHAR(45) NULL,`BookId` VARCHAR(45) NULL,`BookName` VARCHAR(45) NULL,`Address` VARCHAR(45) NULL,`IssueDate` VARCHAR(45) NULL,`SStream` VARCHAR(45) NULL,`SClass` VARCHAR(45) NULL,PRIMARY KEY (`StudentId`));";
                            stmt.execute(query);
                            ...
                            stmt.executeUpdate(query);
                            JOptionPane.showMessageDialog(this,"Book with id- "+t3.getText()+" has been issued to "+t2.getText()+".\n"+"Confirmation email is sending on "+t7.getText()+" address");
                            setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                            sendEmail(t2.getText(),t3.getText(),t4.getText(),t7.getText(),t5.getText()) ;   
                    ...
                    catch(SQLException e)
                    {
                        ...
                        JOptionPane.showMessageDialog(this,"Email not Sent due to smtp server issue");
                        setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
                    }
                }
    ...
    public void sendEmail(String studentName,String bookID,String bookName,String to,String issueDate) 
    {
            // Get properties object
            String from="kodakclick4u@gmail.com";
            String password="useYourWonPassword";
            //String to="umeshmastkoli@gmail.com";
            String sub= bookID+"-"+bookName + " is issued to you";
            String msg= "Dear "+studentName+",\n\n\n"+"Book name- "+bookName+" is issued to you on date: "+issueDate+ "\n"+
                    "Please use book for 3days without any charges. "+ "\n"
                    + "After 3 days charges will be 10 cents per day till 7 days. "+ "\n"
                    + "After 7 days 50 cents charges for each days will be applicable "+"\n\n\n"
                    + "Thank you,"+"\n"+"Library Management";
